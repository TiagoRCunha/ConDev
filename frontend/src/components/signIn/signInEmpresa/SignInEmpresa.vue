    ...
    <div class="text-center">
      <form @submit.prevent="submit" class="contIm bg-dark" novalidate="true">
        <div class="form-group" :class="{ 'form-group--error': $v.name.$error }">
          ...
          <input type="text" class="form-control bgColor btn-outline-secondary" placeholder="Digite o nome comercial" v-model="name" :class="status($v.name)" v-model.trim="$v.name.$model" />
        </div>
        <hr>
        <div class="form-group" :class="{ 'form-group--error': $v.cnpj.$error }">
          <label style="text-align:left">CNPJ</label>
          <input type="email" class="form-control bgColor btn-outline-secondary" placeholder="Digite seu CNPJ" v-model="cnpj" :class="status($v.cnpj)" v-model.trim="$v.cnpj.$model" />
        </div>
        <hr>
        ...
        <div class="form-group" :class="{ 'form-group--error': $v.email.$error }">
          ...
          <select class="form-control" id="tipoUsuario" v-model="tamanhoEmpresa">
            ...
            <!--ligar o select ao banco de dados -->
